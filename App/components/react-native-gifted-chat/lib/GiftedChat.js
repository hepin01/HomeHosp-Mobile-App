...
class GiftedChat extends React.Component {
    ...
    getMessagesContainerHeightWithKeyboard(composerHeight = this.state.composerHeight) {
        const height = this.getBasicMessagesContainerHeight(composerHeight) -
            this.getKeyboardHeight()
        // + this.getBottomOffset()
        // the above line is commented to solve the issue in which the composer 
        // would hide behind the keyboard and would appear again when the user types a message
        return (height);
    }
