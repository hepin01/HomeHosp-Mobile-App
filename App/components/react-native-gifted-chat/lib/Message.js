...
export default class Message extends React.Component {
    ...
    render() {
        ...
        if (currentMessage) {
            ...
            return (<View style={{ marginVertical: getCalculated(12), }}>
                {/* {this.renderDay()} */}
                {currentMessage.system ? (this.renderSystemMessage()) : (<View style={[
                    ...
                    {this.props.position === 'left' ? <View style={{ marginBottom: 22 }}>{this.renderAvatar()}</View> : null}
                    {this.renderBubble()}
                    {this.props.position === 'right' ? <View style={{ marginBottom: 22 }}>{this.renderAvatar()}</View> : null}
                </View>)}
            </View>);
        }
        return null;
