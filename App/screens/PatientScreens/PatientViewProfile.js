...
import {commonStyles, getCalculated} from '../../components/Common';
import ActionSheet from 'react-native-custom-actionsheet';
import {getUserProfile, updateProfileImage} from '../../networking/APIMethods';
import Base from '../Base/Base';
import ImagePicker from 'react-native-image-crop-picker';

class PatientViewProfile extends Base {
  constructor(props) {
    super(props);
    this.state = {
        ...
        <View style={styles.imageBgView}>
          <TouchableOpacity
            ...
            <Image
              ...
              style={[
                styles.imageView,
                {resizeMode: isImageSelected ? 'cover' : 'stretch'},
              ]}
              source={
          ...
          <TouchableOpacity
            ...
            <View style={styles.userNameView}>
              <Text style={commonStyles.Bold17}>
                {user.firstname +
                  ' ' +
                  user.lastname +
...
export default connect(STATE)(PatientViewProfile);
