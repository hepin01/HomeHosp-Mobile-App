...
import StepOneAppointment from './steps/StepOneAppointment';
import StepTwoIntakeCheif from './steps/StepTwoIntakeCheif';
import StepTwoIntakeForm from './steps/StepTwoIntakeForm';
import StepThreePaymentInfo from './steps/StepThreePaymentInfo';
import StepFourFindProvider from './steps/StepFourFindProvider';
...
const mapStateToProps = ({bookedAppointment}) => {
  return {
    ...
    filesToUpload: bookedAppointment.arrFilesToUpload,
    saveCardForFuture: bookedAppointment.saveCardForFuture,
  };
};

export default connect(mapStateToProps)(PatientBookAppointment);
